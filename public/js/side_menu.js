...
//(function(){
	...
	sidemenu.controller('MenuController', ['$scope', '$attrs', '$parse', 'menuConfig', 'menuService','$timeout', '$animate', '$window', function($scope, $attrs, $parse, menuConfig, menuService, $timeout, $animate, $window) {
		var self = this,
    ...
    */
	...
	sidemenu.directive('lateralSlideMenuController', function() {
		return {
	...
	sidemenu.directive('lateralSlideMenu', function() {
		return {
	...
	sidemenu.directive('lateralSlideMenuToggle', function() {
		return {
			require: '^lateralSlideMenuController',
			restrict: 'AE',
			link: function(scope, element, attrs, menuCtrl) {
